            ...
            <div className="row">
                <div className="col-6">
                    <div className="form-group">
                        <p>Food code</p>
                        <input className="form-control" name="maPhim" value={state.values.maSP} disabled onChange={handelChange} />
                    </div>
                    <div className="form-group">
                        <p>Food name</p>
                        <input className="form-control" name="tenPhim" value={state.values.tenSP} onChange={handelChange}/>
